...
const s = {
  ...
  badgeOn:      { background: 'var(--green-bg)', color: 'var(--green)' },
  ...
  copyOk:       { background: 'var(--green-bg)', color: 'var(--green)', borderColor: 'var(--green)' },
  linkHint:     { fontSize: 11, color: 'var(--text3)' },
  warn:         { padding: '8px 10px', background: 'var(--danger-bg)', border: '0.5px solid var(--danger)', borderRadius: 'var(--r)', color: 'var(--danger)', fontSize: 11, lineHeight: 1.5 },
